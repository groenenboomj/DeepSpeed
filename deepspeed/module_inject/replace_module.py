...
from .replace_policy import HFGPT2LayerPolicy, BLOOMLayerPolicy, HFBertLayerPolicy
...
class GroupQuantizer:
    def __init__(self, q_int8=True, num_bits=8, num_groups=32, group_size=1,):
...
#def replace_transformer_layer(orig_layer_impl, model, checkpoint_dict, config, model_config):
    ...
    def replace_with_policy(child, policy_cls, triangular_masking, inference=False, layer_id=0):
        ...
        _container.set_quantization_config(quantizer) #Needed?
