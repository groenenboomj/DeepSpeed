...
>>>>>>> upstream/transformer_inference
*/
                              ...
                              ActivationFuncType act_func_type)
{
    ...
    if (q_bits == 4) out_size *= 2;
    T* inp_norm =
        (T*)InferenceContext::Instance().GetWorkSpace() + torch::numel(input) + torch::numel(output);
/*
=======
 //                             bool q_int8,
   //                           ActivationFuncType act_func_type,
                                    ...
                                    int activation_type)
{
    ...
    if (q_bits == 4) out_size *= 2;
    auto output = at::from_blob((T*)InferenceContext::Instance().GetWorkSpace() + torch::numel(input),
